                            ...
                            <div className="submission-content">
                                <a href="" onClick={() => console.log('submission clicked')}>
                                    <div>
                                        ...
                                        <hr></hr>
                                        <p><span className="submission-info-title">Name: </span>naam artiest</p>
                                        <p><span className="submission-info-title">Uploaded: </span>12/05/2025</p>
                                        <p><span className="submission-info-title">BPM: </span>350</p>
                                    </div>
                                </a>
